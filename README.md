...
Last updated: 2025-12-29 06:43 UTC
...
| [ralph-wiggum](https://github.com/anthropics/claude-plugins-official) | anthropics/claude-plugins-official | Interactive self-referential AI loops for iterative development. Claude works on the same task repeatedly, seeing its previous work, until completion. | Anthropic | 1.0.0 |
