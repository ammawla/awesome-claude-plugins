...
Total Marketplaces: 13 | Total Plugins: 607

Last updated: 2025-12-26 13:36 UTC
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [claude-mem](https://github.com/thedotmack/claude-mem/tree/main/plugin) | thedotmack | Persistent memory system for Claude Code - context compression across sessions | None | 8.2.0 |
...
| [trading-ideas](https://github.com/quant-sentiment-ai/claude-equity-research/tree/main/commands/trading-ideas.md) | claude-equity-research-marketplace | Institutional-grade equity research reports via /trading-ideas command. Analyzes company financials, technical indicators, market positioning, insi... | quant-sentiment-ai | 1.0.0 |
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [game-development](https://github.com/wshobson/agents/blob/main/plugins/game-development) | claude-code-workflows | Unity game development with C# scripting, Minecraft server plugin development with Bukkit/Spigot APIs | Seth Hobson | 1.2.1 |
...
| [fix-issue](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/fix-issue) | cc-marketplace | Addresses GitHub issues by taking issue number as parameter, analyzing context, implementing solution, and testing/validating the fix for proper in... | metabase | 1.0.0 |
...
| [jvm-languages](https://github.com/wshobson/agents/blob/main/plugins/jvm-languages) | claude-code-workflows | JVM language development including Java, Scala, and C# with enterprise patterns and frameworks | Seth Hobson | 1.2.0 |
...
| [seo-content-creation](https://github.com/wshobson/agents/blob/main/plugins/seo-content-creation) | claude-code-workflows | SEO content writing, planning, and quality auditing with E-E-A-T optimization | Seth Hobson | 1.2.0 |
...
| [sugar](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/sugar) | cc-marketplace | Transform Claude Code into an autonomous AI development powerhouse with rich task context, specialized agents, and intelligent workflow automation | Steven Leggett | 2.0.0 |
