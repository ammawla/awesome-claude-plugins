...
Last updated: 2026-01-21 08:39 UTC
...
| [code-review](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/code-review) | cc-marketplace | Perform a comprehensive code review of recent changes |  Anand Tyagi | 1.0.0 |
...
| [systems-programming](https://github.com/wshobson/agents/blob/main/plugins/systems-programming) | claude-code-workflows | Systems programming with Rust, Go, C, and C++ for performance-critical and low-level development | Seth Hobson | 1.2.1 |
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [conductor](https://github.com/wshobson/agents/blob/main/plugins/conductor) | claude-code-workflows | Context-Driven Development plugin that transforms Claude Code into a project management tool with structured workflow: Context → Spec & Plan → Impl... | Seth Hobson | 1.2.0 |
...
| [tdd-workflows](https://github.com/wshobson/agents/blob/main/plugins/tdd-workflows) | claude-code-workflows | Test-driven development methodology with red-green-refactor cycles and code review | Seth Hobson | 1.2.1 |
## Contributing
