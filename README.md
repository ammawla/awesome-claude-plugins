...
Last updated: 2026-01-13 21:27 UTC
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [api-scaffolding](https://github.com/wshobson/agents/blob/main/plugins/api-scaffolding) | claude-code-workflows | REST and GraphQL API scaffolding, framework selection, backend architecture, and API generation | Seth Hobson | 1.2.1 |
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [business-analytics](https://github.com/wshobson/agents/blob/main/plugins/business-analytics) | claude-code-workflows | Business metrics analysis, KPI tracking, financial reporting, and data-driven decision making | Seth Hobson | 1.2.1 |
...
| [supabase](https://github.com/anthropics/claude-plugins-public/tree/main/external_plugins/supabase) | anthropics/claude-plugins-official | Supabase MCP integration for database operations, authentication, storage, and real-time subscriptions. Manage your Supabase projects, run SQL quer... | None | 1.0.0 |
...
| [github-issue-fix](https://github.com/ananddtyagi/claude-code-marketplace/blob/main/plugins/github-issue-fix) | cc-marketplace | This is a detailed way you can analyze the GitHub issues and let Claude handle them in best possible way. | safayavatsal | 1.0.0 |
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [agent-sdk-dev](https://github.com/anthropics/claude-plugins-public/tree/main/plugins/agent-sdk-dev) | anthropics/claude-plugins-official | Development kit for working with the Claude Agent SDK | Anthropic | 1.0.0 |
...
| [greptile](https://github.com/anthropics/claude-plugins-public/tree/main/external_plugins/greptile) | anthropics/claude-plugins-official | AI-powered codebase search and understanding. Query your repositories using natural language to find relevant code, understand dependencies, and ge... | None | 1.0.0 |
...
| [code-documentation](https://github.com/wshobson/agents/blob/main/plugins/code-documentation) | claude-code-workflows | Documentation generation, code explanation, and technical writing with automated doc generation and tutorial creation | Seth Hobson | 1.2.0 |
...
| [web-scripting](https://github.com/wshobson/agents/blob/main/plugins/web-scripting) | claude-code-workflows | Web scripting with PHP and Ruby for web applications, CMS development, and backend services | Seth Hobson | 1.2.0 |
...
| [learning-output-style](https://github.com/anthropics/claude-plugins-public/tree/main/plugins/learning-output-style) | anthropics/claude-plugins-official | Interactive learning mode that requests meaningful code contributions at decision points (mimics the unshipped Learning output style) | Anthropic | 1.0.0 |
...
| Plugin | Marketplace | Description | Author | Version |
|--------|-------------|-------------|--------|---------|
| [payment-processing](https://github.com/wshobson/agents/blob/main/plugins/payment-processing) | claude-code-workflows | Payment gateway integration with Stripe, PayPal, checkout flow implementation, subscription billing, and PCI compliance | Seth Hobson | 1.2.1 |
...
| [security-compliance](https://github.com/wshobson/agents/blob/main/plugins/security-compliance) | claude-code-workflows | SOC2, HIPAA, and GDPR compliance validation, secrets scanning, compliance checklists, and regulatory documentation | Seth Hobson | 1.2.0 |
